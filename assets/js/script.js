...
const texts = {
    ar: {
        dir: 'rtl',
        logo: 'العالم العربي الآن',
        copyright: 'العالم العربي الآن © 2025',
        title: 'الموقع قيد الإنشاء',
        text1: 'نحن نعمل على إطلاق بوابة العالم العربي الآن قريباً.',
    ...
    en: {
        dir: 'ltr',
        logo: 'Arab World Now',
        copyright: 'Arab World Now © 2025',
        title: 'Website Under Construction',
        text1: 'We are working on launching Arab World Now soon.',
